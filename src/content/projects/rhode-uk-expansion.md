---
title: "rhode UK Expansion"
summary: "A market entry strategy for bringing rhode into the UK — anchored on a Sephora UK retail partnership and a four-city community pop-up series that translates the brand's digital intimacy into IRL touchpoints."
class: "BEAU 350 — Global Launch Deck"
classCode: "BEAU 350"
year: "Winter 2026"
order: 10
featured: true
disciplines: ["Brand Strategy", "Market Entry", "Marketing"]
hero:
  label: "Red London phone booth wrapped as a rhode activation — the brand's first IRL UK touchpoint"
  aspectRatio: "16/9"
  src: "/projects/rhode-uk-expansion/hero-phone-booth.png"
inlineImages:
  - label: "London storefront takeover — rhode hoarding wrapping a Mayfair-style townhouse facade"
    aspectRatio: "16/9"
    src: "/projects/rhode-uk-expansion/storefront.png"
    after: "situation"
  - label: "Pop-up cube — a portable, on-brand activation unit that can travel across London, Manchester, Birmingham, and Edinburgh"
    aspectRatio: "16/9"
    src: "/projects/rhode-uk-expansion/popup-cube.png"
    after: "popups"
  - label: "Sephora UK interior — proposed in-store rhode retail moment with mirrors, vanity stations, and seated try-on stools"
    aspectRatio: "16/9"
    src: "/projects/rhode-uk-expansion/sephora-uk.png"
    after: "product"
  - label: "Night activation — illuminated rhode wall paired with a phone-led discovery moment"
    aspectRatio: "16/9"
    src: "/projects/rhode-uk-expansion/night-activation.png"
    after: "audience"
---
